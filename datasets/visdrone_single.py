# Modified for VisDrone dataset
# ------------------------------------------------------------------------
# Based on TransVOD++ vid_single.py
# Copyright (c) 2022 Shanghai Jiao Tong University. All Rights Reserved.
# Licensed under the Apache License, Version 2.0 [see LICENSE for details]
# ------------------------------------------------------------------------

"""
VisDrone dataset loader for single-frame training (Deformable DETR baseline)
"""
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "train_joint": [(root / "Data" / "VID", root / "annotations" / 'imagenet_vid_train.json')],
